...
public class Quiz_fruits extends Activity {
	...
	private void shuffle() 
	{
		...
		randomnumber[0] = rand.nextInt(Constants.fruitsPhotos.length);

		randomnumber[1] = rand.nextInt(Constants.fruitsPhotos.length);
		while (randomnumber[1] == randomnumber[0])
			randomnumber[1] = rand.nextInt(Constants.fruitsPhotos.length);

		randomnumber[2] = rand.nextInt(Constants.fruitsPhotos.length);
		while ((randomnumber[2] == randomnumber[0])
				|| (randomnumber[2] == randomnumber[1]))
			randomnumber[2] = rand.nextInt(Constants.fruitsPhotos.length);

		randomnumber[3] = rand.nextInt(Constants.fruitsPhotos.length);
		...
		media = MediaPlayer.create(Quiz_fruits.this, Constants.fruitsSound[randomnumber[position]]);
		media.start();
		...
		op1.setBackgroundResource(Constants.fruitsPhotos[randomnumber[0]]);
		op2.setBackgroundResource(Constants.fruitsPhotos[randomnumber[1]]);
		op3.setBackgroundResource(Constants.fruitsPhotos[randomnumber[2]]);
		op4.setBackgroundResource(Constants.fruitsPhotos[randomnumber[3]]);
	}
	
	
	private void clapmedia() {
		media = MediaPlayer.create(Quiz_fruits.this, R.raw.clap);
		media.start();
